...
TEST_CASE("testing resizeArray(newSize) method on an empty BinHeap", "[RESIZEARRAY]") {
    ...
    SECTION("verify that resizeArray(newSize) properly resizes the backing array (doubles its size)") {
        ...
        INFO("after calling resizeArray(newSize), backing array should be dpuble the size");
...
TEST_CASE("testing leftIndex(idx) method", "[LEFTINDEX]") {
    BinHeap<int> heap;
    REQUIRE(heap.leftIndex(1) == 2);
    REQUIRE(heap.leftIndex(2) == 4);
    REQUIRE(heap.leftIndex(3) == 6);
    REQUIRE(heap.leftIndex(4) == 8);
    REQUIRE(heap.leftIndex(5) == 10);
    REQUIRE(heap.leftIndex(6) == 12);
    REQUIRE(heap.leftIndex(7) == 14);
    REQUIRE(heap.leftIndex(8) == 16);
    REQUIRE(heap.leftIndex(9) == 18);
    REQUIRE(heap.leftIndex(10) == 20);
}
...
TEST_CASE("testing rightIndex(idx) method", "[RIGHTINDEX]") {
    BinHeap<int> heap;
    REQUIRE(heap.rightIndex(1) == 3);
    REQUIRE(heap.rightIndex(2) == 5);
    REQUIRE(heap.rightIndex(3) == 7);
    REQUIRE(heap.rightIndex(4) == 9);
    REQUIRE(heap.rightIndex(5) == 11);
    REQUIRE(heap.rightIndex(6) == 13);
    REQUIRE(heap.rightIndex(7) == 15);
    REQUIRE(heap.rightIndex(8) == 17);
    REQUIRE(heap.rightIndex(9) == 19);
    REQUIRE(heap.rightIndex(10) == 21);
}
